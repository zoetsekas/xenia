/**
 */
package language.business.businessEntity.provider;
...
/**
 * This is the item provider adapter for a {@link language.business.businessEntity.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider extends BusinessEntityItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InformationPackage.Literals.ENTITY__EXTENSION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Person.class)) {
			case BusinessEntityPackage.PERSON__EXTENSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InformationPackage.Literals.ENTITY__EXTENSION,
