/**
 */
package language.business.financial.product.provider;


import java.util.Collection;
import java.util.List;

import language.architecture.information.provider.EntityItemProvider;
...
/**
 * This is the item provider adapter for a {@link language.business.financial.product.FinancialProduct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FinancialProductItemProvider extends EntityItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProductPackage.Literals.FINANCIAL_PRODUCT__TRADE_LEGS);
			childrenFeatures.add(ProductPackage.Literals.FINANCIAL_PRODUCT__OPTIONS);
			childrenFeatures.add(ProductPackage.Literals.FINANCIAL_PRODUCT__TRIGGERS);
		}
	...
	public String getText(Object object) {
		String label = ((FinancialProduct)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProductPackage.Literals.FINANCIAL_PRODUCT__TRADE_LEGS,
				 ProductFactory.eINSTANCE.createTradeLeg()));

		newChildDescriptors.add
			(createChildParameter
				(ProductPackage.Literals.FINANCIAL_PRODUCT__OPTIONS,
				 ProductFactory.eINSTANCE.createOption()));

		newChildDescriptors.add
			(createChildParameter
				(ProductPackage.Literals.FINANCIAL_PRODUCT__TRIGGERS,
