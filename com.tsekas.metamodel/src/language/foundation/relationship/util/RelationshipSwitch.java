...
public class RelationshipSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RelationshipPackage.META_RELATIONSHIP: {
				MetaRelationship metaRelationship = (MetaRelationship)theEObject;
				T result = caseMetaRelationship(metaRelationship);
				if (result == null) result = caseMetaPackageableElement(metaRelationship);
				if (result == null) result = caseMetaNamedElement(metaRelationship);
				if (result == null) result = caseMetaElement(metaRelationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationshipPackage.META_INHERITANCE: {
				MetaInheritance metaInheritance = (MetaInheritance)theEObject;
				T result = caseMetaInheritance(metaInheritance);
				if (result == null) result = caseMetaRelationship(metaInheritance);
				if (result == null) result = caseMetaPackageableElement(metaInheritance);
				if (result == null) result = caseMetaNamedElement(metaInheritance);
				if (result == null) result = caseMetaElement(metaInheritance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
