...
public class DatatypeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DatatypePackage.META_DATA_TYPE: {
				MetaDataType metaDataType = (MetaDataType)theEObject;
				T result = caseMetaDataType(metaDataType);
				if (result == null) result = caseMetaPackageableElement(metaDataType);
				if (result == null) result = caseMetaNamedElement(metaDataType);
				if (result == null) result = caseMetaElement(metaDataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypePackage.META_TEXT: {
				MetaText metaText = (MetaText)theEObject;
				T result = caseMetaText(metaText);
				if (result == null) result = caseMetaDataType(metaText);
				if (result == null) result = caseMetaPackageableElement(metaText);
				if (result == null) result = caseMetaNamedElement(metaText);
				if (result == null) result = caseMetaElement(metaText);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Meta Text</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Meta Text</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMetaText(MetaText object) {
		return null;
	}
