...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>financialProduct</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.financialProduct"));
				FinancialProduct root = ProductFactory.eINSTANCE.createFinancialProduct();
