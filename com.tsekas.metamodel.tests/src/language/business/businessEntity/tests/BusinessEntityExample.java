...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>businessEntity</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BusinessEntityExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(BusinessEntityPackage.eNS_URI, 
			 BusinessEntityPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.businessentity"));
				Organisation root = BusinessEntityFactory.eINSTANCE.createOrganisation();
