...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>information</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class InformationExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.information"));
				Domain root = InformationFactory.eINSTANCE.createDomain();
